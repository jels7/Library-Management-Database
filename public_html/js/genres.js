...
addRowToTable = (data) => {
    ...
    row.setAttribute('data-value', newRow.genreID); // Set data-value attribute
    ...
    deleteButton.dataset.id = newRow.genreID;

    // Create edit button
    let editButton = document.createElement("button");
    editButton.innerHTML = "Edit";
    editButton.classList.add("edit-btn");
    editButton.dataset.id = newRow.genreID;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    genresTable.addEventListener("click", function (event) {
